 ...
 * of reference or array types, the className of the class being referred to.
 * </p>
 */
public enum FieldType {
     ...
     * @param ch the character representing the type (must match one of those listed in
     * prim_typecode or obj_typecode in the Object Serialization Stream Protocol)
     * @param javatype the className of the object class, where applicable (or null if not)
     */
    ...
    /**
     * Gets the class className for a reference or array type.
     *
     * @return the className of the class being referred to, or null if this is not a
