 ...
 * </p>
 */
public class ClassDescription extends ContentBase {
    /**
     * Type of the class being represented; either a normal class or a proxy class.
     */
    public ClassDescriptionType classtype;
     ...
     */
    public ClassDescription(ClassDescriptionType classtype) {
        super(ContentType.CLASSDESC);
        this.classtype = classtype;
        this.enumconstants = new HashSet<String>();
        this.innerclasses = new ArrayList<ClassDescription>();
    }
     ...
     */
    public void addInnerClass(ClassDescription cd) {
        innerclasses.add(cd);
    }
    ...
    public String toString() {
        ...
        sb.append("[cd ").append(JDeserializer.hex(handle)).append(": className ").append(name);
     ...
     */
    public void getHierarchy(ArrayList<ClassDescription> classes) {
        if(superclass != null) {
            if(superclass.classtype == ClassDescriptionType.PROXYCLASS) {
                JDeserializer.debugerr("warning: hit a proxy class in superclass hierarchy");
            } else {
